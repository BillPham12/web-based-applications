...
var paypal            = require('paypal-rest-sdk');//require paypal rest dk to hash-code client id and client secret
...
paypal.configure({
  ...
  'client_secret': 'xxxxxxxxxxxxxxxxxxxxxxxx' // client secret
});
